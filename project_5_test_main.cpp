...
int main()
{
    ...
    std::cout << std::endl
              << "--- Set initialization / insert ---" << std::endl;
    ...
    std::cout << std::endl
              << "--- Copy constructor / clear ---" << std::endl;
    Set *D{new Set{A}};
    std::cout << "A:       " << A << std::endl;  // {1,2,3}
    std::cout << "B:       " << B << std::endl;  // {2,3,4}
    ...
    *D = B;
    ...
    std::cout
        << std::endl
        << "--- merge ---" << std::endl;
    std::cout << "merge Z and N: " << Z.merge(N) << std::endl; // 1
    std::cout << "Z after merge: " << Z << std::endl;          // {4,3,2,1}
